	...
	protected void configure(HttpSecurity http) throws Exception {
	    ...
	    .authorizeRequests()
	        .antMatchers("/",
				...
				.antMatchers("/student/").hasAnyAuthority("ADMIN","TEACHER","PRINCIPAL","TEACHER_LEADER")
				.antMatchers("/teacher/").hasAnyAuthority("ADMIN","TEACHER","PRINCIPAL","TEACHER_LEADER")
				.antMatchers("/teacherLeader/").hasAnyAuthority("ADMIN","TEACHER","PRINCIPAL","TEACHER_LEADER")
				.antMatchers("/roster/").hasAnyAuthority("ADMIN","TEACHER","PRINCIPAL","TEACHER_LEADER")
				.antMatchers("/grade/").hasAnyAuthority("ADMIN","STUDENT","TEACHER","PRINCIPAL","TEACHER_LEADER")
